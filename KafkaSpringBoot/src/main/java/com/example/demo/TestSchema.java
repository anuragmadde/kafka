...
public class TestSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3467642282225560471L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TestSchema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"postcode\",\"type\":\"int\"}]}");
   ...
   */
  public TestSchema(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence email, java.lang.Integer postcode) {
    this.id = id;
    this.name = name;
    this.email = email;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: postcode = (java.lang.Integer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static TestSchema.Builder newBuilder() {
    return new TestSchema.Builder();
  }
   ...
   * @return A new TestSchema RecordBuilder
   */
  public static TestSchema.Builder newBuilder(TestSchema.Builder other) {
    return new TestSchema.Builder(other);
  }
   ...
   * @return A new TestSchema RecordBuilder
   */
  public static TestSchema.Builder newBuilder(TestSchema other) {
    return new TestSchema.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestSchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(TestSchema.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.postcode)) {
        this.postcode = data().deepCopy(fields()[3].schema(), other.postcode);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(TestSchema other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder setPostcode(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TestSchema.Builder clearPostcode() {
    ...
    public TestSchema build() {
      try {
        ...
        record.postcode = fieldSetFlags()[3] ? this.postcode : (java.lang.Integer) defaultValue(fields()[3]);
        return record;
